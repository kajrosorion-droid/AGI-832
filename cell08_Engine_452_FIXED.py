        ...
        for _, speaker in scored:
            ...
            def _local_task(a=speaker, b=found, t_now=t):
                try:
                    ...
                    voice_a = "Говори от первого лица, кратко. " + build_agent_voice(a, self, compact=True)
